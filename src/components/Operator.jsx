      ...
      <div className="op-grid">
        <div className="op-lead">
          ...
          <Reveal delay={140} style={{ margin: 0, fontSize: 'clamp(15px,1.3vw,18px)', lineHeight: 1.65, color: 'var(--bone-dim)', maxWidth: '58ch' }}>
            <span style={{ color: 'var(--cool)' }}>Currently</span> — B.E. Computer Engineering at TSEC Mumbai, grinding competitive programming in Python and shipping agentic side-projects between hackathons.
          </Reveal>
        </div>
